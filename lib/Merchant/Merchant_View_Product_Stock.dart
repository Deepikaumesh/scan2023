...
class _Merchant_View_Product_stockState extends State<Merchant_View_Product_stock> {
  ...
  Future<List<User>> getRequest() async {
    ...
    String url =
        "http://$ip_address/Scanner_2023/Merchant/Merchant_View_Product_Stock.php";
  ...
  Future<void> delrecord(String id) async {
    String url =
        "http://$ip_address/Scanner_2023/Merchant/Merchant_Delete_Stock_Product.php";
    ...
    if (resoponse["success"] == "true") {
      print("record deleted");
       setState(() {
  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=>Merchant_View_Product_stock()));
      });
