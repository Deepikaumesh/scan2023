...
Future Merchant_Login() async {
  var url =
      "http://$ip_address/Scanner_2023/Merchant/Merchant_login.php"; //intego wifi password
  ...
  if (data != null) {
    for (var singleUser in data) {
      ...
      final _MerchantsharedPrefs = await SharedPreferences.getInstance();

      await _MerchantsharedPrefs.setString("merchant_id", singleUser["id"]);
